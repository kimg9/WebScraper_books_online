...
def product_parsing(product_page_url):
    ...
    print('----------------------------------------')
    print(f'SUCCESS: Successfully fetched page')
    print('----------------------------------------')
    ...
    title = product.findChild("h1").text
    image_url = "https://books.toscrape.com/" + (product.find('div', {'class': 'item active'}).findChild('img', recursive=False)['src'])
    ...
    print("SUCCESS: Successfully parsed elements")
    print('----------------------------------------')
    #--------------------------------------------------------------------------------------
